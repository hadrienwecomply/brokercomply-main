...
export function BrokerLogo({
  ...
  return (
    <div className="flex flex-col items-start gap-1">
      ...
      {hasLogo ? (
        <div className="group relative size-24 shrink-0 overflow-hidden rounded-xl border border-line bg-white">
        ...
        <button
          ...
          disabled={busy}
          onClick={() => fileRef.current?.click()}
          className="flex size-24 shrink-0 flex-col items-center justify-center gap-1.5 rounded-xl border border-dashed border-line bg-white text-xs font-medium text-ink-soft hover:border-brand-300 hover:text-brand-700"
